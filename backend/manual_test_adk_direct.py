...
import os
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '/Users/sargupta/AIPodcast/service-account-key.json'
...
try:
    ...
    if hasattr(result, 'response_message'):
        ...
        print(f"Response Message attrs: {[attr for attr in dir(resp_msg) if not attr.startswith('_')][:15]}")
